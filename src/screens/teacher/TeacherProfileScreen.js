...
const TeacherProfileScreen = ({ navigation }) => {
  ...
  const getInitial = () => {
    if (teacherUser?.full_name) {
      return teacherUser.full_name.charAt(0);
    }
    return 'م';
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.profileImageContainer}>
        ...
        <Text style={styles.userName}>{teacherUser?.full_name}</Text>
        <Text style={styles.userRole}>معلم</Text>
      </View>
      ...
      <View style={styles.infoCard}>
        <View style={styles.infoRow}>
          ...
          <View style={styles.infoContent}>
            ...
            <Text style={styles.infoValue}>{teacherUser?.email}</Text>
          </View>
        </View>
        ...
        {teacherUser?.phone && (
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoContent}>
              ...
              <Text style={styles.infoValue}>{teacherUser.phone}</Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.infoRow}>
          ...
          <View style={styles.infoContent}>
            ...
            <Text style={styles.infoValue}>{teacherUser?.username}</Text>
          </View>
        </View>
      </View>
